...
describe('Shape Classes', () => {
  test('Triangle render', () => {
    ...
    shape.setTextColor('red'); // Set the text color to 'red'
  ...
  test('Circle render', () => {
    ...
    shape.setTextColor('green'); // Set the text color to 'green'
  ...
  test('Square render', () => {
    ...
    shape.setTextColor('blue'); // Set the text color to 'blue'
